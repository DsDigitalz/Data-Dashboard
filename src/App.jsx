        ...
        {activeTab === "tech-news" && (
          <div className="flex flex-col items-center justify-center py-32 text-center">
            ...
            <p className="text-sm text-zinc-500 max-w-sm">
              Return to{" "}
              <button onClick={() => setActiveTab("dashboard")} className="text-indigo-400 hover:text-indigo-300 underline cursor-pointer">Overview</button>{" "}
              or{" "}
              <button onClick={() => setActiveTab("security")} className="text-indigo-400 hover:text-indigo-300 underline cursor-pointer">Cybersecurity</button>.
            </p>
          </div>
        )}
      </main>
